...
public class Main_web extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postheader = bundle.getString("aws");
        postnamaresep = bundle.getString("awss");

       // postUrl = "https://cookpad.com/id/resep/1439615-capcay-goreng-bakso";
    ...
    private void initCollapsingToolbar() {
        ...
        collapsingToolbar.setTitle(postnamaresep);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle("Mirip Chef");
                    isShow = true;
                } else if (isShow) {
        ...
        Glide.with(getApplicationContext()).load(postheader)
                .thumbnail(0.5f)
                .crossFade()
