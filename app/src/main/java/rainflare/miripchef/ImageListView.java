...
public  String nama_resep;
   public static String aw;
    public static final String GET_IMAGE_URL = "http://gopacitan.co.id/miripchef/get_alldata.php";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_youtube) {
            ...
            try {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("vnd.youtube:" + "S37yvdjhRGI"));
                ...
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtube.com/watch?v=S37yvdjhRGI" + id));
                startActivity(i);
            }
    ...
    public String getFacebookPageURL(Context context) {
        ...
        try {
            ...
            if (versionCode >= 3002850) { //newer versions of fb app
                return "fb://facewebmodal/f?href=" + "https://www.facebook.com/Mirip-Chef-241152976290845";
            } else { //older versions of fb app
                return "fb://page/" + "Mirip-Chef-241152976290845";
            }
        } catch (PackageManager.NameNotFoundException e) {
            return "https://www.facebook.com/Mirip-Chef-241152976290845"; //normal web url
        }
    }
    private void getImages() {
        class GetImages extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPostExecute(Void v) {
                ...
                CustomList customList = new CustomList(ImageListView.this, GetAlImages.id_resep, GetAlImages.nama_resep, GetAlImages.bitmaps);
   ...
   private void gethero() {
    ...
    private void showEmployee(String json) {
        try {
           ...
           header = c.getString(config.TAG_header);
           nama_resep = c.getString(config.TAG_nama_resep);
        ...
        //    name_hero  = c.getString(config.hero_name);
            ...
            intent.putExtra("aw",link);
            intent.putExtra("aws",header);
            intent.putExtra("awss",nama_resep);
       //     Toast.makeText(ImageListView.this, link, Toast.LENGTH_SHORT).show();
            startActivity(intent);
